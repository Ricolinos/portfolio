...
const SECTION_KEYS = ["current", "finished"];

// Aproxima el layout real de ClientDashboardPage (heading + métricas +
// acciones + dos listas de proyectos) para evitar layout shift al hidratar.
