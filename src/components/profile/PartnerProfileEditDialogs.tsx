...
import { Button, Column, Feedback, Modal, Row, Slider, Switch, Text } from "@once-ui-system/core";
...
function canvasToCoverDataUrl(canvas: HTMLCanvasElement): string {
...
function CoverCropper({
  ...
  useEffect(() => {
    exportRef.current = async () => {
      ...
      return canvasToCoverDataUrl(canvas);
    };
    return () => {
